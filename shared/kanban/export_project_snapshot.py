...
SNAPSHOT_DIR = REPO_ROOT / "data" / "kanban_snapshots"
...
def fetch_project_items(
    ...
    """Pagina os itens do Project (v2). Nao usa shared.pagination.paginate porque
    nodes/pageInfo aqui ficam aninhados em user.projectV2.items, nao num campo de
    nivel superior da resposta."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Caminho do CSV de saida. Default: data/kanban_snapshots/snapshot_<sprint>_<data>.csv",
    )
