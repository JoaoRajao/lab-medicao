...
| Tentativas intermediarias nao registradas | A ferramenta grava so o resultado final; as execucoes de `check` de cada trial nao sao registradas. Para o P1 foram recuperadas do log da sessao; P2 e P3 nao tem esse dado. | Reportar o resultado final como metrica de RQ2 e o registro do P1 apenas como observacao descritiva; em trabalhos futuros, gravar cada `check` na ferramenta. |
