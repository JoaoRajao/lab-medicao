...
- Arquivo local: `labs/lab01_repos_populares/config/popular_languages.json`
- Linguagens consideradas populares: TypeScript, Python, JavaScript, Java, C++ e C#.

## 2. Metodologia de coleta

A coleta foi implementada em Python no script `labs/lab01_repos_populares/ingest.py`. O script usa a API GraphQL do GitHub por meio da biblioteca padrao `urllib`, sem PyGithub, SDK do GitHub, cliente GraphQL externo ou biblioteca de terceiros para consultar a API.
...
- DuckDB local: `data/warehouse.duckdb`;
- Parquet versionado: `labs/lab01_repos_populares/data/parquet/repositories.parquet`;
- tabela bronze de origem: `lab01_repos_populares`.
...
- Bronze: tabela `lab01_repos_populares`, escrita pela ingestao Python no DuckDB e exportada para Parquet.
- Silver: modelos em `models/staging/lab01`, que padronizam a leitura e expõem datasets intermediarios.
- Gold: modelos em `models/gold/lab01`, com agregacoes finais para cada RQ.
...
- Snapshot de sprint: exportado por `shared/kanban/export_project_snapshot.py` para CSV em `data/kanban_snapshots/`.
...
| --- | --- | --- |
| Lab01S01 | `data/kanban_snapshots/snapshot_Lab01S01_2026-08-14.csv` | 2026-08-14 |
| Lab01S02 | `data/kanban_snapshots/snapshot_Lab01S02_2026-08-20.csv` | 2026-08-20 |
| Lab01S03 | `data/kanban_snapshots/snapshot_Lab01S03_2026-08-27.csv` | 2026-08-27 |
...
No momento do print, #10 e #11 estavam concluidas (`Done`), #12 e #13 em `Review`, e #14 (esta propria issue, de snapshot final) em `In Progress` -- consistente com o snapshot `Lab01S03` exportado em `data/kanban_snapshots/snapshot_Lab01S03_2026-08-27.csv`.
